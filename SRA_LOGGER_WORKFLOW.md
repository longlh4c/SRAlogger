...
> 2. AI sẽ tự khởi chạy Subagent:
>    * **Kiểm tra trạng thái đăng nhập:** Đầu tiên Subagent sẽ truy cập trang và kiểm tra xem tài khoản đã được đăng nhập sẵn hay chưa. Nếu đã có session/đăng nhập từ trước, Subagent sẽ **bỏ qua hoàn toàn bước đăng nhập** và chuyển thẳng sang bước log timesheet.
>    * **Nếu chưa đăng nhập:** AI sẽ tự động điền tài khoản Google của bạn để đăng nhập.
